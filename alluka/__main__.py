...
def send_start(bot, update):
    ...
    try:
        ...
        pass
    chat = update.effective_chat  # type: Optional[Chat]
    text = "Hey there, my name is Kosaki Onodera! "
    text += "\nI am an anime themed group management bot with a lot of fun features"
    ...
    keyboard += [[InlineKeyboardButton(text="🔌 Add me",url="http://t.me/zoldycktmbot?startgroup=true"),InlineKeyboardButton(text="👤 Support chat",url="https://t.me/joinchat/OyuYchtnoF2KqWWgGunEkA")]]
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                ...
                                                InlineKeyboardButton(text="👥 Support chat.",url="https://t.me/RemBotsupport")]]))
        return
